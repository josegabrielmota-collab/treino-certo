...
export class AnatomyViewerComponent {
  ...
  muscleGroups = [
    ...
    },
    {
      ...
      function: 'Adutores, extensores e rotadores internos do braço; estabilizadores da coluna.',
      importance:
    ...
    },
    {
      ...
      function: 'Abdução (elevação lateral), flexão (frente) e extensão (trás) do braço.',
      importance:
    ...
    },
    {
      ...
      function: 'Flexão, extensão e desvios do pulso; flexão dos dedos (pegada).',
      importance:
    ...
    },
    {
      ...
      function: 'Extensão, abdução e rotação externa do quadril; estabilização da pelve.',
      importance:
    ...
    },
    {
      ...
      function: 'Flexão, rotação e inclinação do tronco; compressão abdominal (estabilidade).',
      importance:
